...
function senddata() {
    ...
    if (process == 'insert') {
        var id_usuario = 0;
        var urlprocess = 'agregar_docnete.php';
    ...
    if (process == 'edited') {
        ...
        var dataString = 'process=' + process + '&nombre=' + nombre + '&descripcion=' + descripcion + '&id_docente=' + id_docente + "&codigo=" + codigo + "&unidades=" + unidades
    }
    $.ajax({
        type: 'POST',
        url: urlprocess,
