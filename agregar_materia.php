                    ...
                    <form name="formulario" id="formulario">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="Ingrese el nombre de la materia"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="Ingrese el codigo de la materia"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" placeholder="Ingrese las unidades valorativas de la materia"
                                    class="form-control" id="unidades" name="unidades">
                            </div>
                        </div>
                        <div class="row">
