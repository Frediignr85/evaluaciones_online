...
function senddata()
{
	...
	if(process=='insert')
	{
		...
		var dataString='process='+process+'&nombre='+nombre+'&usuario='+usuario+'&clave='+clave+'&admin='+admin+'&activo='+activo+"&id_empleado="+id_empleado;
	}
	if(process=='edited')
	{
		var id_usuario=$('#id_usuario').val();
		var urlprocess='editar_usuario.php';
		var dataString='process='+process+'&nombre='+nombre+'&usuario='+usuario+'&clave='+clave+'&admin='+admin+'&id_usuario='+id_usuario+'&activo='+activo+"&id_empleado="+id_empleado;
	}
