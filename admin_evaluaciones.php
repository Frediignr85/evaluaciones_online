    ...
    <div class="row" id="row1">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
				...
				if ($link!='NOT' || $admin=='1' )
					echo "<a href='agregar_evaluacion.php' class='btn btn-primary' role='button'><i class='fa fa-plus icon-large'></i> Agregar Evaluacion</a>";
				echo "</div>";
                ...
                <div class="ibox-content">
                    ...
                    <div class="modal fade bd-example-modal-lg" id="viewModal1" tabindex="-1" role="dialog"
